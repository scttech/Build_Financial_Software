...
class AchParsingValidationError(Exception):
    ...
    def __init__(self, message: str = "Error parsing ACH record", validation_errors: Any = None):
    ...
    def get_exception_codes(self) -> list[str]:
        ...
        for error in self.validation_errors:
            if error['loc'][0] == 'file_id_modifier':
                ...
                exception_codes.append(AchExceptions.INVALID_IMMEDIATE_DESTINATION.value)
