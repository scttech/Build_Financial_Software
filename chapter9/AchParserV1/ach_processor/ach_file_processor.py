...
from chapter9.AchParserV1.ach_processor.ach_exceptions import AchExceptions
from chapter9.AchParserV1.ach_processor.database.ach_addenda_ppd_sql import AchAddendaPpdSql
from chapter9.AchParserV1.ach_processor.database.ach_batch_control_sql import AchBatchControlSql
from chapter9.AchParserV1.ach_processor.database.ach_batch_header_sql import AchBatchHeaderSql
from chapter9.AchParserV1.ach_processor.database.ach_entry_ppd_details_sql import AchEntryPpdDetailsSql
from chapter9.AchParserV1.ach_processor.database.ach_file_control_sql import AchFileControlSql
from chapter9.AchParserV1.ach_processor.database.ach_file_header_sql import AchFileHeaderSql
from chapter9.AchParserV1.ach_processor.database.ach_records_sql_type_1 import AchRecordsSqlType1
from chapter9.AchParserV1.ach_processor.database.ach_records_sql_type_5 import AchRecordsSqlType5
from chapter9.AchParserV1.ach_processor.database.ach_records_sql_type_6 import AchRecordsSqlType6
from chapter9.AchParserV1.ach_processor.database.ach_records_sql_type_7 import AchRecordsSqlType7
from chapter9.AchParserV1.ach_processor.database.ach_records_sql_type_8 import AchRecordsSqlType8
from chapter9.AchParserV1.ach_processor.database.ach_records_sql_type_9 import AchRecordsSqlType9
from chapter9.AchParserV1.ach_processor.database.ach_records_sql_type_invalid import AchRecordsSqlTypeInvalid
from chapter9.AchParserV1.ach_processor.database.exception.ach_exceptions_sql import AchExceptionsSql
from chapter9.AchParserV1.ach_processor.record_parser.ach_record_parser import AchRecordProcessor
from chapter9.AchParserV1.ach_processor.record_parser.exceptions.ach_parsing_validation_error import AchParsingValidationError
from chapter9.AchParserV1.ach_processor.schemas.database.ach_record.ach_record_type_1_schema import (
    AchRecordType1Schema,
)
from chapter9.AchParserV1.ach_processor.schemas.database.ach_record.ach_record_type_5_schema import (
    AchRecordType5Schema,
)
from chapter9.AchParserV1.ach_processor.schemas.database.ach_record.ach_record_type_6_schema import (
...
from chapter9.AchParserV1.ach_processor.schemas.database.ach_record.ach_record_type_8_schema import (
    AchRecordType8Schema,
)
from chapter9.AchParserV1.ach_processor.schemas.database.ach_record.ach_record_type_9_schema import (
    AchRecordType9Schema,
)
from chapter9.AchParserV1.ach_processor.schemas.database.ach_record.ach_record_type_invalid_schema import AchRecordTypeInvalidSchema
...
class AchFileProcessor:
    ...
    def _parse_entry_ppd_detail(self, ach_file_id: UUID, current_batch_header_id: UUID, ach_records_type_6_id: UUID,
                            sequence_number: int, line: str):
    ...
    def _add_exception(exception: AchExceptionSchema, line=None) -> None:
        ...
        if line is not None:
            ...
            sql_invalid_rec.insert_record(AchRecordTypeInvalidSchema(
