...
class AchFilesResponse(BaseModel):
    ...
    originator: Optional[str] = Field(
        None,
        description="The name of the financial institution that originated the ACH file.",
        title="Immediate Origin Name",
        max_length=23,
    )
    ...
    has_exceptions: bool = Field(
        default=...,
        description="Indicates if there are exceptions for the ACH file.",
