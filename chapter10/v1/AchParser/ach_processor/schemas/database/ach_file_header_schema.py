...
from chapter10.v1.AchParser.ach_processor.database.bank.bank_routing_sql import BankRoutingSql
...
class AchFileHeaderSchema(BaseModel):
    ...
    file_id_modifier: Annotated[str, StringConstraints(pattern=r'^[A-Z]$', min_length=1, max_length=1)]
    record_size: str
    blocking_factor: str
    format_code: str
