...
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.database.ach_addenda_ppd_sql import (
    AchAddendaPpdSql,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.database.ach_batch_control_sql import (
    AchBatchControlSql,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.database.ach_batch_header_sql import (
    AchBatchHeaderSql,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.database.ach_entry_ppd_details_sql import (
    AchEntryPpdDetailsSql,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.database.ach_file_control_sql import (
    AchFileControlSql,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.database.ach_file_header_sql import (
    AchFileHeaderSql,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.database.ach_records_sql import (
    AchRecordsSql,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.schemas.ach_addenda_ppd_schema import (
    AchAddendaPpdSchema,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.schemas.ach_batch_control_schema import (
    AchBatchControlSchema,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.schemas.ach_batch_header_schema import (
    AchBatchHeaderSchema,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.schemas.ach_entry_ppd_details_schema import (
    AchEntryPpdDetailsSchema,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.schemas.ach_file_control_schema import (
    AchFileControlSchema,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.schemas.ach_file_header_schema import (
    AchFileHeaderSchema,
)
from chapter5.AchProcessor_V4_PreAchRecordRefactor.ach_processor.schemas.ach_record_schema import (
    AchRecordSchema,
)
...
class AchFileProcessor:
        ...
        with open(filename, "r") as file, self.get_db() as conn:
            ...
            for line in lines:
                ...
                match record_type:
                    ...
                    case "5":
                        self._parse_batch_header(
                            ach_record_id, current_file_header_id, line
                        )
                        current_batch_header_id = ach_record_id
                    case "6":
                        self._parse_entry_ppd_detail(
                            ach_record_id, current_batch_header_id, line
                        )
    ...
    def _parse_file_header(self, ach_record_id: UUID, line: str):
    ...
    def _parse_batch_header(
        self, ach_record_id: UUID, current_file_header_id: UUID, line: str
    ):
    ...
    def _parse_entry_ppd_detail(
        self, ach_record_id: UUID, current_batch_header_id: UUID, line: str
    ):
    ...
    def _parse_addenda_ppd(
        self, ach_record_id: UUID, current_entry_id: UUID, line: str
    ):
