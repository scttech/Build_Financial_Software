...
from chapter5.AchProcessor_V2_PreAPICode.ach_processor.database.ach_file_sql import (
    AchFileSql,
)
...
from chapter5.AchProcessor_V2_PreAPICode.ach_processor.schemas.ach_file_header_schema import (
    AchFileHeaderSchema,
)
...
class SqlUtils:
    ...
    def create_ach_file_record() -> str:
        ...
        ach_file_id = AchFileSql().insert_record(
            AchFileSchema(file_name="sample.ach", file_hash="1234567890")
        )
