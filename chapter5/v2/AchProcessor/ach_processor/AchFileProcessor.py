...
class AchFileProcessor:
    ...
    def parse(self, filename) -> [List, List]:
        ...
        with open(filename, "r") as file, self.get_db() as conn:
            ...
            for line in lines:
                ...
                conn.execute("""
                INSERT INTO ach_records (file_name, unparsed_record, sequence_number) 
                VALUES (%s, %s, %s)
    ...
    def _parse_file_header(self, conn: Connection[tuple[Any, ...]], line: str) -> Dict[str, str]:
        ...
        conn.execute(
            """
            INSERT INTO ach_file_headers (ach_file_headers_id,
                           ...
                           VALUES (DEFAULT, %(record_type_code)s, %(priority_code)s, %(immediate_destination)s,
                           %(immediate_origin)s, %(file_creation_date)s, %(file_creation_time)s,
                            %(file_id_modifier)s, %(record_size)s, %(blocking_factor)s, %(format_code)s,
                            %(immediate_destination_name)s, %(immediate_origin_name)s, %(reference_code)s)
                            """, file_header)
    ...
    def _parse_batch_header(self, conn: Connection[tuple[Any, ...]], line: str) -> Dict[str, str]:
        ...
        conn.execute(
            """
            INSERT INTO ach_batch_headers (ach_batch_headers_id, record_type_code, service_class_code, company_name,
            ...
            VALUES (DEFAULT, %(record_type_code)s, %(service_class_code)s, %(company_name)s,
    ...
    def _parse_entry_ppd_detail(self, conn: Connection[tuple[Any, ...]], line: str) -> Dict[str, str]:
        ...
        conn.execute(
            """
            INSERT INTO ach_entry_ppd_details (ach_entry_ppd_details_id, record_type_code, transaction_code,
            ...
            VALUES (DEFAULT, %(record_type_code)s, %(transaction_code)s, %(receiving_dfi_identification)s,
    ...
    def _parse_addenda_ppd(self, conn: Connection[tuple[Any, ...]], line: str) -> Dict[str, str]:
        ...
        conn.execute(
            """
            INSERT INTO ach_addenda_ppd_records (ach_addenda_ppd_records_id, record_type_code, addenda_type_code,
            payment_related_information, addenda_sequence_number, entry_detail_sequence_number)
            VALUES (DEFAULT, %(record_type_code)s, %(addenda_type_code)s, %(payment_related_information)s,
    ...
    def _parse_batch_control(self, conn: Connection[tuple[Any, ...]], line: str) -> Dict[str, str]:
        ...
        conn.execute(
            """
            INSERT INTO ach_batch_control_records (ach_batch_control_records_id, record_type_code,
        ...
        VALUES (DEFAULT, %(record_type_code)s, %(service_class_code)s, %(entry_addenda_count)s,
    ...
    def _parse_file_control(self, conn: Connection[tuple[Any, ...]], line: str) -> Dict[str, str]:
        ...
        conn.execute(
            """
            INSERT INTO ach_file_control_records (ach_file_control_records_id, record_type_code, batch_count, 
            block_count, entry_addenda_count, entry_hash, total_debit_entry_dollar_amount,
            total_credit_entry_dollar_amount, reserved)
            VALUES (DEFAULT, %(record_type_code)s, %(batch_count)s, %(block_count)s,
