...
class TestAchFileHeaderSql:
    ...
    def test_insert_record(self):
        ...
        assert SqlUtils.get_row_count_of_1("ach_file_headers") is True, "Expected 1 record"
        assert retrieved_record == ach_file_header_record, f"Expected {ach_file_header_record}, but got {retrieved_record}"