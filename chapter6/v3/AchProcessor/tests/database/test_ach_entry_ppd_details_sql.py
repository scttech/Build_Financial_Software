...
from chapter6.AchProcessor_V2_PreAPICode.ach_processor.schemas.ach_entry_ppd_details_schema import \
...
class TestAchEntryPpdDetailsSql:
    ...
    def test_insert_record(self):
        ...
        ach_records_type_5_id, ach_records_type_6_id = SqlUtils.setup_entry_ppd_details_test(sample_ach_entry_ppd_details_record)
        ...
        assert SqlUtils.get_row_count_of_1("ach_entry_ppd_details") is True, "Expected 1 record"
        assert retrieved_record == ach_entry_ppd_details_record, f"Expected {ach_entry_ppd_details_record}, but got {retrieved_record}"