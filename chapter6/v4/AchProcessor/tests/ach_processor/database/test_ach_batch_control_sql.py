...
class TestAchBatchHeaderSql:
    ...
    def test_insert_record(self):
        ...
        ach_records_type_5_id, ach_records_type_8_id = SqlUtils.setup_batch_control_test(sample_batch_control_record)
        ...
        assert SqlUtils.get_row_count_of_1("ach_batch_control_records") is True, "Expected 1 record"
        assert retrieved_record == ach_batch_control_record, f"Expected {ach_batch_control_record}, but got {retrieved_record}"