...
from chapter6.AchProcessor_V2.ach_processor.ach_file_processor import AchFileProcessor
...
def test_parse_batch_control():
    ...
    ach_batch_header_record_id, ach_batch_control_record_id = SqlUtils.setup_batch_control_test(sample_batch_control_record)

    parser._parse_batch_control(ach_batch_control_record_id,
                                         sample_batch_control_record)
