...
def test_parse_entry_ppd_details():
    ...
    ach_batch_header_record_id, ach_entry_ppd_details_record_id = SqlUtils.setup_entry_ppd_details_test(sample_entry_detail_record)
    parser._parse_entry_ppd_detail(ach_entry_ppd_details_record_id,
