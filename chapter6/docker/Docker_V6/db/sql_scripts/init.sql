...
CREATE TABLE ach_file_headers (
    ach_records_id UUID UNIQUE NOT NULL REFERENCES ach_records(ach_records_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE ach_batch_headers (
    ach_records_id UUID UNIQUE NOT NULL REFERENCES ach_records(ach_records_id) ON DELETE CASCADE ON UPDATE CASCADE,
    ach_file_headers_id UUID NOT NULL REFERENCES ach_file_headers(ach_records_id) ON DELETE CASCADE ON UPDATE CASCADE,
    record_type_code VARCHAR(1) NOT NULL,
...
CREATE TABLE ach_entry_ppd_details (
    ach_records_id UUID UNIQUE NOT NULL REFERENCES ach_records(ach_records_id) ON DELETE CASCADE ON UPDATE CASCADE,
    ach_batch_headers_id UUID NOT NULL REFERENCES ach_batch_headers(ach_records_id) ON DELETE CASCADE ON UPDATE CASCADE,
    record_type_code VARCHAR(1) NOT NULL,
...
CREATE TABLE ach_addenda_ppd_records (
    ach_records_id UUID UNIQUE NOT NULL REFERENCES ach_records(ach_records_id) ON DELETE CASCADE ON UPDATE CASCADE,
    ach_entry_ppd_details_id UUID NOT NULL REFERENCES ach_entry_ppd_details(ach_records_id) ON DELETE CASCADE ON UPDATE CASCADE,
    record_type_code VARCHAR(1) NOT NULL,
