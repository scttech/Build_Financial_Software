...
from chapter6.AchProcessor_V2.ach_processor.database.ach_addenda_ppd_sql import AchAddendaPpdSql
from chapter6.AchProcessor_V2.ach_processor.database.ach_batch_control_sql import AchBatchControlSql
from chapter6.AchProcessor_V2.ach_processor.database.ach_batch_header_sql import AchBatchHeaderSql
from chapter6.AchProcessor_V2.ach_processor.database.ach_entry_ppd_details_sql import AchEntryPpdDetailsSql
from chapter6.AchProcessor_V2.ach_processor.database.ach_file_control_sql import AchFileControlSql
from chapter6.AchProcessor_V2.ach_processor.database.ach_file_header_sql import AchFileHeaderSql
from chapter6.AchProcessor_V2.ach_processor.database.ach_records_sql_type_1 import AchRecordsSqlType1
from chapter6.AchProcessor_V2.ach_processor.database.ach_records_sql_type_5 import AchRecordsSqlType5
from chapter6.AchProcessor_V2.ach_processor.database.ach_records_sql_type_6 import AchRecordsSqlType6
from chapter6.AchProcessor_V2.ach_processor.database.ach_records_sql_type_7 import AchRecordsSqlType7
from chapter6.AchProcessor_V2.ach_processor.database.ach_records_sql_type_8 import AchRecordsSqlType8
from chapter6.AchProcessor_V2.ach_processor.database.ach_records_sql_type_9 import AchRecordsSqlType9
from chapter6.AchProcessor_V2.ach_processor.record_parser.ach_record_parser import AchRecordProcessor
from chapter6.AchProcessor_V2.ach_processor.schemas.ach_record.ach_record_type_1_schema import AchRecordType1Schema
from chapter6.AchProcessor_V2.ach_processor.schemas.ach_record.ach_record_type_5_schema import AchRecordType5Schema
from chapter6.AchProcessor_V2.ach_processor.schemas.ach_record.ach_record_type_6_schema import AchRecordType6Schema
from chapter6.AchProcessor_V2.ach_processor.schemas.ach_record.ach_record_type_7_schema import AchRecordType7Schema
from chapter6.AchProcessor_V2.ach_processor.schemas.ach_record.ach_record_type_8_schema import AchRecordType8Schema
from chapter6.AchProcessor_V2.ach_processor.schemas.ach_record.ach_record_type_9_schema import AchRecordType9Schema
...
class AchFileProcessor:
    ...
    def _parse_file_header(self,
        ...
        ach_file_header = AchRecordProcessor().parse_file_header(ach_records_type_1_id, line)
    ...
    def _parse_batch_header(self,
        ...
        ach_batch_header = AchRecordProcessor().parse_batch_header(ach_records_type_5_id, line)
    ...
    def _parse_entry_ppd_detail(self,
        ...
        ach_entry_ppd_detail_record = AchRecordProcessor().parse_entry_ppd_detail(ach_records_type_6_id, line)
    ...
    def _parse_addenda_ppd(self,
        ...
        addenda_ppd_record = AchRecordProcessor().parse_addenda_ppd(ach_records_type_7_id, line)
    ...
    def _parse_batch_control(self,
        ...
        batch_control_record = AchRecordProcessor().parse_batch_control(ach_records_type_8_id, line)
    ...
    def _parse_file_control(self,
        ...
        file_control_record = AchRecordProcessor().parse_file_control(ach_records_type_9_id, line)
