...
def when_the_record_is_parsed(
    ...
    ach_file_header_record_id, ach_batch_header_record_id = SqlUtils.setup_batch_header_test(batch_header_record)
    ach_file_processor._parse_batch_header(ach_batch_header_record_id,
                                           batch_header_record)
