...
class SqlUtils:
    ...
    def get_row_count_of_1(table_name: str = '') -> bool:
        ...
        with SqlUtils.get_db() as conn:
            query = SQL("SELECT COUNT(*) FROM {table_name}").format(table_name=Identifier(table_name))
    ...
    def truncate(table_name: str = '') -> None:
        """Truncate the table."""
        with SqlUtils.get_db() as conn:
            query = SQL("TRUNCATE {table_name}").format(table_name=Identifier(table_name))
            conn.execute(query)
    ...
    @staticmethod
    def create_ach_file_record() -> str:
        """
        Create a dummy record in the ach_files table to use as a foreign key.
        :return:
        """
        ach_file_id = AchFileSql().insert_record(AchFileSchema(
    ...
    def setup_file_header_test(unparsed_record: str) -> UUID:
        ...
        ach_record_id = AchRecordsSqlType1().insert_record(AchRecordType1Schema(
    ...
    def create_ach_file_header() -> UUID:
        ...
        ach_file_header_id = AchFileHeaderSql().insert_record(AchFileHeaderSchema(
    ...
    def setup_batch_header_test(sample_batch_header_record: str):
        ...
        ach_records_type_1_id = AchRecordsSqlType1().insert_record(AchRecordType1Schema(
            ach_files_id=ach_file_id,
            unparsed_record="101 267084131 6910001340402200830A094101DEST NAME              ORIGIN NAME            XXXXXXXX",
            sequence_number=1
        ))
        # Create a dummy batch header record
        ach_records_type_5_id = AchRecordsSqlType5().insert_record(AchRecordType5Schema(
    ...
    def setup_batch_control_test(sample_batch_control_record):
        ...
        ach_records_type_8_id = AchRecordsSqlType8().insert_record(AchRecordType8Schema(
    ...
    def setup_file_control_test(sample_file_control_record):
        ...
        ach_records_type_9_id = AchRecordsSqlType9().insert_record(AchRecordType9Schema(
            ach_records_type_1_id=ach_records_type_1_id,
    ...
    def setup_entry_ppd_details_test(sample_ach_entry_ppd_details_record):
        ...
        ach_records_type_6_id = AchRecordsSqlType6().insert_record(AchRecordType6Schema(
            ach_records_type_5_id=ach_records_type_5_id,
    ...
    def setup_addenda_ppd_test(sample_ach_addenda_ppd_record):
        ...
        ach_records_type_7_id = AchRecordsSqlType7().insert_record(AchRecordType7Schema(
