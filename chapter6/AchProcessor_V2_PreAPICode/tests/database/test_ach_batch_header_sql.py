...
class TestAchBatchHeaderSql:
    ...
    def test_insert_record(self):
        ...
        ach_records_type_1_id, ach_records_type_5_id = SqlUtils.setup_batch_header_test(sample_batch_header)
        ...
        assert SqlUtils.get_row_count_of_1("ach_batch_headers") is True, "Expected 1 record"
        assert retrieved_record == ach_batch_header_record, f"Expected {ach_batch_header_record}, but got {retrieved_record}"