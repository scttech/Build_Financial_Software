...
class TestAchAddendaPpdSql:
    ...
    def test_insert_record(self):
        ...
        ach_records_type_6_id, ach_records_type_7_id = SqlUtils.setup_addenda_ppd_test(sample_addenda_ppd_record)
        ...
        assert SqlUtils.get_row_count_of_1("ach_addenda_ppd_records") is True, "Expected 1 record"
        assert retrieved_record == ach_addenda_ppd_record, f"Expected {ach_addenda_ppd_record}, but got {retrieved_record}"