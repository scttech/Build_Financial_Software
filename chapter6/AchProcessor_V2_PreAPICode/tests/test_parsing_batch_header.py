...
def test_parse_batch_header():
    ...
    ach_file_header_record_id, ach_batch_header_record_id = SqlUtils.setup_batch_header_test(sample_batch_header)
    parser._parse_batch_header(ach_batch_header_record_id,
                               sample_batch_header)
